pipeline {
    ...
    stages {
        ...
        stage('ping server') {
            steps {
                  ansiblePlaybook credentialsId: 'jenkins_private-ansible', disableHostKeyChecking: true, installation: 'ansible', inventory: 'terraform/inventory.ini', playbook: 'terraform/playbook.yml'
                }
            }
    }
    post {
